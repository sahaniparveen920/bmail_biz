...
class InputTextFieldScreenShareWidget extends GetView<HomeController> {

  final String hintText;

  const InputTextFieldScreenShareWidget({super.key, required controller, required this.hintText, keyboardType, readOnly = false});

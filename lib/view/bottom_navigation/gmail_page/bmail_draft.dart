...
class BmailDraftPage extends StatefulWidget {
  const BmailDraftPage({super.key});

  @override
  State<BmailDraftPage> createState() => _BmailDraftPageState();
}

class _BmailDraftPageState extends State<BmailDraftPage> {
  late List<Emails> DraftsEmails;  // Empty list, meaning no drafts
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          if (success == true && emails != null) {
            DraftsEmails = emails.cast<Emails>();  // Update trashedEmails
          } else {
        ...
        children: [
          ...
          Expanded(
            child: _isLoading
                ...
                : DraftsEmails.isEmpty
                ? Center(child: Text('No emails found'))
                : ListView.builder(
              itemCount: DraftsEmails.length,
              itemBuilder: (context, index) {
                final email = DraftsEmails[index];
